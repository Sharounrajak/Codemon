...
const CreateSnippet = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Prepare data for backend (add missing required fields)
    const dataToSend = {
      ...snippetData,
      tags: snippetData.tags.map((tag) => tag.toLowerCase()),
      author: "Anonymous User", // Add required field
      avatar: "AU", // Add required field
      userId: "user-123", // Add for tracking
      isDemo: false, // Mark as user-created
    };
